...
<section>
        ...
        <div class="d-flex align-items-center justify-content-center mb-0">
            <div class="col-lg-10 col-md-10 col-sm-12 col-12 p-5 text-center position-relative" id="sobrenos-content">
                ...
                <div class="reveal container w-75" id="sobrenos-text">
                    <p style="color: #000">Somos um ONG formada majoritariamente por mulheres, e que busca instruir a
                        sociedade em relação ao abandono, cuidados com os felinos, entre outros.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-5 col-md-12 col-sm-12 col-12 p-5">
                <div class="reveal2">
                    <h2 class="fw-bold my-3 fs-1" id="title">Nós ajudamos a construir uma sociedade melhor!</h3>
                        <p>Nossa ONG nasceu em 2014, e desde o início nosso objetivo é ajudar os gatinhos, que ainda são
                            estigmatizados em nossa sociedade.<br><br>
                            Por isso nossa missão é conscientizar e instruir a população de maneira responsável,
                            realizando um trabalho social almejando reduzir a população de gatos de rua.
                        </p>
                </div>
                <div id="botao">
                    <a href="#sobre" class="text-button text-center"><button type="button"
                            class="btn btn-lg fw-bold mb-3" id="button1">Quero ajudar!</button></a>
                </div>
            </div>
    ...
    <div class="container-fluid px-0 text-white position-relative mb-4" id="sobre">
        <div class="col-12 p-4 text-dark">
            <div class="container pt-3 mb-5" id="secao1">
                ...
                <p>
                    Nossa ong depende 100% da SUA AJUDA. Existem algumas frentes para ajudar a nossa ong, e temos
                    certeza que uma delas vai dar certo com você.</p>
                </p>
                <ul>
    ...
    <div class="container-fluid px-0 text-white position-relative" id="adote">
        <div class="row align-items-center px-5 flex-sm-row-reverse">
            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="reveal2">
                    ...
                    <p>Olá. Aqui é a Sissi. Quando cheguei na ONG, estava assustada e bem insegura. Com o tempo, ganhei
                        confiança e percebi que as tias não iriam me machucar. Assim, fui adotada e achei que seria
                        feliz, que teria uma família e um ambiente acolhedor para evoluir.<br><br>
                        Porém, não foi bem assim… fui devolvida após alguns meses. Não tiveram paciência comigo e com
                        minha evolução. Agora, estou esperando uma nova chance de ser feliz. Ainda sou um tanto quanto
                        insegura, então preciso de um humano paciente e amoroso.<br>
                        Será que é você?
                    </p>
                </div>
            </div>
        ...
        <div class="container-fluid px-4">
            <h3 class='fw-bold text-muted'>Assim como Sissi...<br>Esses gatos também precisam de um lugar para se chamar
                de lar</h3>
        </div>
        ...
        <div class="rifas d-flex justify-content-center align-items-center overflow-hidden position-relative">
            ...
            <div class="hero_content h-100 container-xxl position-relative text-center align-items-center">
                <div class="container-fluid w-75 reveal2" style="color: black; margin-top: 5%;" id="rifas-conteudo">
                    ...
                    <div id="botao">
                        <a href="https://api.whatsapp.com/message/KT46S26DKF5QO1?autoload=1&app_absent=0"
                            class="text-button text-center"><button type="button" class="btn btn-lg fw-bold mb-3"
                                id="button2">Quero comprar</button></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 p-5">
                <div>
                    ...
                    <p>Somos uma ONG virtual, ou seja, não possuímos um espaço físico.<br><br>
                        Nós atuamos em parcerias com clínicas veterinárias, onde nossos gatos ficam durante o tratamento
                        de doenças ou enquanto aguardam lares temporários. Lares temporários são voluntários que cedem o
                        seu espaço (carinho, dedicação e muito mais) para receber os miaus até a doação, sendo todos os
                        insumos providos pela ONG.<br><br>
                        Além dos lares temporários, temos um grande número de voluntárias que ajudam a realizar a
                        logística desse nosso projeto. São elas as tias do resgate, do CED, as veterinárias, a tia do
                        financeiro, nossa advogata, a voluntária que coordena os LTs, a tia da Rifinha, as meninas da
                        comunicação e as voluntárias que cuidam de todas as mensagens que recebemos de vocês em nossas
                        redes sociais.<br><br>
                        Pessoas que doam seu tempo, suas habilidades e muito carinho para ajudar nossos gatinhos. Você
                        quer ser uma dessas pessoas? Então se torne um voluntário.
                        Tá esperando o quê?
                    </p>
                </div>
                <div id="botao">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 container-fluid px-5">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-12 p-0 align-items-center">
                        <div class="mb-2 reveal2">
                            <div style="height:300px; overflow:hidden"><img src="files/images/cat1.png"
                                    class="image-fluid w-100" style="height: auto"></div>
                        </div>
                        <div class="reveal2">
                            <div style="height:300px; overflow:hidden"><img src="files/images/cat2.png"
                                    class="image-fluid w-100"></div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-12 pt-5" style="top:-250px">
                        <div class="reveal2"
                            style=" height:550px; background-image: url('files/images/cat3.png'); background-repeat: no-repeat">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 pt-3 reveal2 p-0"><img src="files/images/cat4.png" class="image-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center mb-0">
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 p-5">
                <div>
                    ...
                    <p class="text-white mb-3">A Crazy Cat Gang resgata animais das mais diversas situações de maus tratos,
                        abandono e sofrimento. Se você encontrar uma situação em que o animal se encontra em situações
                        que necessitam de resgate, contate a equipe de resgate imediatamente!<br>
                        Você pode entrar em contato clicando no botão abaixo:
                    <div id="botao">
                        <a href="https://wa.me/554196085890" class="text-button text-center"><button type="button"
                                class="btn btn-lg fw-bold mb-3" id="button4">Entre em contato</button></a>
                    </div>
                    </p>
                </div>
            </div>
    ...
    <div class="container-fluid px-0 text-white position-relative" style="background-color: #000" id="doacao">
        <div class="row align-items-center mb-0 flex-sm-row-reverse px-5">
            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                <div>
                    <h1 class="fw-bold my-3 fs-1 text-white" id="title">Você doa, e nós continuamos a resgatar e cuidar
                        dos gatinhos em situação de risco</h1>
            ...
            <div class="hero_content h-100 container-xxl position-relative">
                <div class="d-flex h-100 align-items-center">
                    <div class="container-fluid px-5 text-white text-center">
                        <h3 class="fw-semibold mb-1 fs-1" id="header-title">Gostou da gente?<br>Quer saber mais do mundo
                            felino?<br></h3>
                        <div id="botao" class="pt-2 mb-3">
                            <a href="https://crazycatgang.com.br/?page_id=2" class="text-button text-center"><button
                                    type="button" class="btn btn-lg fw-bold" id="button1">Acesse o nosso
                                    blog</button></a>
                        </div>
                        <p class="text-white">Também acesse nossas redes sociais!</p>
                        <ul class="text-center d-flex justify-content-center position-relative" id="redes2">
                            <li><a href="https://www.instagram.com/crazycatgang/" target="_blank">
                                    <ion-icon name="logo-instagram"></ion-icon>
                                </a></li>
                            <li><a href="https://x.com/crazycatgangcwb" target="_blank">
                                    <ion-icon name="logo-twitter"></ion-icon>
                                </a></li>
                            <li><a href="https://www.facebook.com/crazycatgang/?locale=pt_BR" target="_blank">
