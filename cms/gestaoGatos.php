...
<div class="main container-fluid p-5">
    <div class="d-flex justify-content-between">
        <h1>Gatos</h1>
        <a href="adicionarGato.php" class="text-button text-center"><button type="button" class="btn btn-lg fw-bold mb-3" id="button1"><b><i class="lni lni-circle-plus"></i></b> Adicionar Gato</button></a>
    </div>

    <div class="table-responsive">
        <form action="gestaoGatos.php" method="post">
        ...
        if (isset($_POST["buscar"])) {
            ...
            $query = mysqli_query($conexao, "SELECT * FROM gato WHERE nome LIKE '%$varBuscar%' ORDER BY id DESC");
        } else {
            $query = mysqli_query($conexao, "SELECT * FROM gato ORDER BY id DESC");
        }
            ...
            <table class="table table-bordered table-striped table-hover justify-content-center">
                ...
                while ($exibe = mysqli_fetch_array($query)) {
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a class="btn btn-primary d-flex justify-content-center" href="editarGato.php?idb=<?php echo $exibe['id'] ?>">Editar</a></td>
                    </tr>
                <?php } ?>
            </table>
        <?php } ?>
